...
const styles = StyleSheet.create({
  ...
  placeHelp: { color: '#4B3A55', lineHeight: 19 },
  ...
  emptyPlaceText: { color: '#51485A', marginTop: 4, lineHeight: 18 },
  ...
  placeMeta: { color: '#5E5366', fontSize: 13, marginTop: 2 },
  ...
  eventMeta: { color: '#5E5366', fontSize: 12, marginTop: 3 },
  ...
  selectedStatus: { color: '#51485A', marginTop: 3 },
  ...
  pausedText: { color: '#51485A', lineHeight: 20 },
  ...
  memberMeta: { color: '#5E5366', fontSize: 13, marginTop: 3 },
